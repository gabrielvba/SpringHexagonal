...
public class TransformOrderDtoToModel {
	...
	public Order toModel(com.github.gabrielvba.ms_order_management.infrastructure.adapter.in.rest.dto.Order order) {
	...
	public Payment toPaymentModel(
			com.github.gabrielvba.ms_order_management.infrastructure.adapter.in.rest.dto.Payment dto) {
		if (dto == null) {
			return null;
		} else {
...
//			payment.setOrderId(dto.orderId());
	...
	public List<ProductItem> toProductItemModelList(
			List<com.github.gabrielvba.ms_order_management.infrastructure.adapter.in.rest.dto.ProductItem> productItemDtoList) {
		if (productItemDtoList == null)
			return Collections.emptyList();

		return productItemDtoList.stream().map(dto -> {
	...
	public PaymentStatus stringToPaymentStatus(String status) {
		if (status == null) {
			return null;
		}
		try {
