package com.gabriel.vba.storeReact.infrastructure.adapter.out;
...
import com.gabriel.vba.storeReact.infrastructure.adapter.out.implementation.OrderJpaRepository;
import com.gabriel.vba.storeReact.infrastructure.adapter.out.implementation.ProductJpaRepository;
...
@Log4j2
@Component
public class H2RepositoryAdapterOut implements BDRepository {
	@Autowired
