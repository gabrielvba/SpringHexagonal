...
import com.github.gabrielvba.ms_order_management_react.application.port.in.CrudProductUserCase;
import com.github.gabrielvba.ms_order_management_react.infrastructure.adapter.in.rest.dto.Product;
import com.github.gabrielvba.ms_order_management_react.infrastructure.adapter.in.transform.TransformProductDtoToModel;
...
public class ProductController {
	...
	@PostMapping
	public Mono<ResponseEntity<com.github.gabrielvba.ms_order_management_react.domain.model.Product>> criarProduto(@RequestBody Product product) {
	...
	@GetMapping
	public Flux<com.github.gabrielvba.ms_order_management_react.domain.model.Product> listarProdutos() {
		log.info("List products");
		return productUserCase.listarProdutos();
	}

	@PutMapping("/{id}")
	public Mono<ResponseEntity<com.github.gabrielvba.ms_order_management_react.domain.model.Product>> atualizarProduto(@PathVariable Long id, @RequestBody Product product) {
